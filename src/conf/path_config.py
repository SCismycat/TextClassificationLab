...
# bert Base Model
path_embedding_bert = path_root + '/data/chinese_L-12_H-768_A-12/'
# xlnet base model
path_embedding_xlnet = path_root + '/data/chinese_xlnet_mid_L-24_H-768_A-12/'
# albert base model
...
# fast_text config
# 模型目录
path_model_dir = path_root + "/data/model/"
# 语料地址
path_model = path_root + '/data/model/model_fast_text.h5'
# 超参数保存地址
path_hyper_parameters = path_root + '/data/model/hyper_parameters.json'
# embedding微调保存地址
path_fineture = path_root + "/data/model/embedding_trainable.h5"

# 训练目录
data_path_file_train = path_root + "/data/xinhuanet/train.csv"
data_path_file_valid = path_root + "/data/xinhuanet/valid.csv"
